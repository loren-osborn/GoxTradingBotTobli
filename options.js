...
*/
	...
	localStorage.ApiKey = bkgdPg.mtGoxApiKey = document.getElementById("apikey").value;
	localStorage.ApiSec = bkgdPg.mtGoxApiSecret = document.getElementById("apisec").value;
...
function setfields() {
	document.getElementById("apikey").value = bkgdPg.mtGoxApiKey;
	document.getElementById("apisec").value = bkgdPg.mtGoxApiSecret;
