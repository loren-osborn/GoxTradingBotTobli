describe("jasmine extensions", function() {
    ...
    it("add jasmine.iterateOverTestDataSets() method", function() {
        ...
        expect(function () {
            jasmine.iterateOverTestDataSets([{name: 'Albert', data: 5}], {}, uncalledFunction);
        }).toThrow('Dataset[0].data must be an Array.');
        expect(function () {
            jasmine.iterateOverTestDataSets([{name:'Fred', data: [1,2,3]},{name: 'Albert'}], {}, uncalledFunction);
        }).toThrow('Dataset[1].data must be an Array.');
        expect(function () {
            jasmine.iterateOverTestDataSets([{name:'Fred', data: [1,2,3]},{name:'George', data: [2,4,6]},{data: [9]}], {}, uncalledFunction);
        }).toThrow('Dataset[2].name must be a non-empty string.');
        expect(function () {
            jasmine.iterateOverTestDataSets([{name:'Fred', data: [1,2,3]},{name:'George', data: [2,4,6]},{name:'Fred', data: [9]}], {}, uncalledFunction);
        }).toThrow('Dataset[2].name must not match Dataset[0].name.');
        expect(function () {
            jasmine.iterateOverTestDataSets([{name:'Fred', data: [1,2,3]},{name:'George', data: []}], {}, uncalledFunction);
        }).toThrow('Dataset[1].data must be non-empty.');
        var callback = jasmine.createSpy('test callback');
        jasmine.iterateOverTestDataSets([{name:'Larry', data: [1,2,3]}, {name:'Moe', data: ['a', 'c']}, {name:'Curly', data: ['b', 'd']}], {}, callback);
        ...
        jasmine.iterateOverTestDataSets([{name:'Larry', data: [1,2,3]}, {name:'Moe', data: ['a', 'c']}, {name:'Curly', data: ['b', 'd']}], {Moe: ['q', 'r', 's']}, callback);
